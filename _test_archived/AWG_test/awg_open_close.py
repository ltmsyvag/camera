...
# start_frequency_table = [[95e6],[96e6]]
# end_frequency_list = [[101e6],[101e6]]
# move_time = 1

# controller.run_the_procedure(0, 30, [True,True], [101e6,101e6], start_frequency_table, end_frequency_list, 1, move_time, 0.01, 'cosine')
# input("Press Enter to Exit")
# controller.run_the_procedure(1, 30, [True, True], [101e6, 101e6], start_frequency_table, end_frequency_list, 1,
#                                 move_time, 0.01, 'cosine')
# input("Press Enter to Exit")
# controller.run_the_procedure(2, 30, [True, True], [101e6, 101e6], start_frequency_table, end_frequency_list, 1,
#                                 move_time, 0.01, 'cosine')
